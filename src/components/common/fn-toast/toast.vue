<template>
    <div name="fn-toast-pop">
        <div class="fn-toast" v-show="visible" :class="customClass" :style="{ 'padding': iconClass === '' ? '10px' : '20px' }">
            <i class="fn-toast-icon" :class="iconClass" v-if="iconClass !== ''"></i>
            <span class="fn-toast-text" :style="{ 'padding-top': iconClass === '' ? '0' : '10px' }">{{ message }}</span>
        </div>
    </div>
</template>
